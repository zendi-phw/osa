...
/**
 * The main mod_osa questiontype delete textelement configuration form.
 *
 * @package     mod_osa
...
require_once($CFG->dirroot.'/mod/osa/classes/form/delete_questiontype_textelement_class.php');
...
$url = new moodle_url('/mod/osa/delete_questiontype_textelement.php', ['id' => $cmid, 'textelement' => $textelementid]);

$PAGE->set_url($url);
$PAGE->set_title(get_string('pagetitledeletetextelement', 'mod_osa') . ' ' . format_string($osa->name));
...
echo $OUTPUT->confirm(
    ...
    new moodle_url('/mod/osa/classes/form/delete_questiontype_textelement_class.php', ['id'  => $cmid, 'textelement' => $textelementid]),
